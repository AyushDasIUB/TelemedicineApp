 ...
 * @author dasay
 */
public class FXMLNurseDashboardSceneController implements Initializable {
    ...
    private void trainingButtonOnAction(ActionEvent event) {
        loadPage("FXMLNurseTrainingCertificationsScene");
    }
    ...
    private void loadPage(String page){
        ...
        try{
          root = FXMLLoader.load(getClass().getResource(page+".fxml"));
              ...
              Logger.getLogger(FXMLNurseDashboardSceneController.class.getName()).log(Level.SEVERE, null, ex);
        }
